...
Escreva um programa que verifique se um número é primo usando operadores de comparação e lógicos.

Manipulação de Strings:

Crie um programa que verifique se uma determinada substring está presente em uma string e exiba o resultado.
...
Teste cada exercício com diferentes valores para garantir que está funcionando corretamente.
"""